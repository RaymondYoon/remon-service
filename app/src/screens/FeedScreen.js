...
export default function FeedScreen({ navigation }) {
  ...
  const openBook = (book) => navigation.navigate('BookDetail', { bookId: book.id });
      ...
      {loading
        ...
        : (
          <FlatList
            ...
            ListEmptyComponent={<Text style={styles.empty}>팔로우한 사람의 책이 없습니다.</Text>}
          />
        )
      }
    </View>
