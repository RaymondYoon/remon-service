...
### AI 책 생성
- 키워드(최대 4개), 장르(9종: SF/판타지/로맨스/일상/공포/액션/스릴러/드라마/느와르), 분위기(7종, **최대 2개 다중 선택**), 결말(해피/새드/열린결말), 주인공 이름(**최대 3명**), 성격(13종, **최대 3개 다중 선택**), 서술 시점(1인칭/3인칭), **한 줄 시놉시스**, **조연 등장인물(최대 4명)** → Google Gemini API로 **6,000자** 소설 자동 생성
